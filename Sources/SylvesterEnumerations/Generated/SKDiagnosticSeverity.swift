...
public enum SKDiagnosticSeverity: String, Equatable, Codable, CodingKey, CaseIterable, SourceKitUID {
    ...
    public static var caseMap: [String: String] {
        [
        "note": "source.diagnostic.severity.note",
        "warning": "source.diagnostic.severity.warning",
        "error": "source.diagnostic.severity.error",
        ]
    }
}
