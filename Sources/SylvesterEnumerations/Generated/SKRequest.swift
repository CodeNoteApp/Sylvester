...
public enum SKRequest: String, Equatable, Codable, CodingKey, CaseIterable, SourceKitUID {
    ...
    public static var caseMap: [String: String] {
        [
        "protocolVersion": "source.request.protocol_version",
        "compilerVersion": "source.request.compiler_version",
        "crashExit": "source.request.crash_exit",
        "demangle": "source.request.demangle",
        "mangleSimpleClass": "source.request.mangle_simple_class",
        "indexsource": "source.request.indexsource",
        "docinfo": "source.request.docinfo",
        "codecomplete": "source.request.codecomplete",
        "codecompleteOpen": "source.request.codecomplete.open",
        "codecompleteClose": "source.request.codecomplete.close",
        "codecompleteUpdate": "source.request.codecomplete.update",
        "codecompleteCacheOndisk": "source.request.codecomplete.cache.ondisk",
        "codecompleteSetpopularapi": "source.request.codecomplete.setpopularapi",
        "codecompleteSetcustom": "source.request.codecomplete.setcustom",
        "typecontextinfo": "source.request.typecontextinfo",
        "conformingmethods": "source.request.conformingmethods",
        "activeregions": "source.request.activeregions",
        "cursorinfo": "source.request.cursorinfo",
        "rangeinfo": "source.request.rangeinfo",
        "relatedidents": "source.request.relatedidents",
        "editorOpen": "source.request.editor.open",
        "editorOpenInterface": "source.request.editor.open.interface",
        "editorOpenInterfaceHeader": "source.request.editor.open.interface.header",
        "editorOpenInterfaceSwiftsource": "source.request.editor.open.interface.swiftsource",
        "editorOpenInterfaceSwifttype": "source.request.editor.open.interface.swifttype",
        "editorExtractComment": "source.request.editor.extract.comment",
        "editorClose": "source.request.editor.close",
        "editorReplacetext": "source.request.editor.replacetext",
        "editorFormattext": "source.request.editor.formattext",
        "editorExpandPlaceholder": "source.request.editor.expand_placeholder",
        "editorFindUsr": "source.request.editor.find_usr",
        "editorFindInterfaceDoc": "source.request.editor.find_interface_doc",
        "buildsettingsRegister": "source.request.buildsettings.register",
        "moduleGroups": "source.request.module.groups",
        "nameTranslation": "source.request.name.translation",
        "convertMarkupXml": "source.request.convert.markup.xml",
        "statistics": "source.request.statistics",
        "findSyntacticRenameRanges": "source.request.find-syntactic-rename-ranges",
        "findLocalRenameRanges": "source.request.find-local-rename-ranges",
        "semanticRefactoring": "source.request.semantic.refactoring",
        "enableCompileNotifications": "source.request.enable-compile-notifications",
        "testNotification": "source.request.test_notification",
        "expressionType": "source.request.expression.type",
        "variableType": "source.request.variable.type",
        "configurationGlobal": "source.request.configuration.global",
        "dependencyUpdated": "source.request.dependency_updated",
        "diagnostics": "source.request.diagnostics",
        "semanticTokens": "source.request.semantic_tokens",
        "compile": "source.request.compile",
        "compileClose": "source.request.compile.close",
        "enableRequestBarriers": "source.request.enable_request_barriers",
        "syntacticMacroExpansion": "source.request.syntactic_macro_expansion",
        "indexToStore": "source.request.index_to_store",
        ]
    }
}
