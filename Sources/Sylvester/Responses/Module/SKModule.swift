...
open class SKGenericModule<S: SKBaseSubstructure, T: SKGenericSwiftDocs<S>> {
    ...
    public lazy var sdkPath: String? = module.sdkPath

    /// The target (triple) architecture the module was compiled for (e.g. `"arm64-apple-ios12.1"`).
    public lazy var target: String? = module.target
    ...
    public init(
        ...
        name: String? = nil,
        inPath path: String = FileManager.default.currentDirectoryPath
    ) throws {
        self.module = try SylvesterInterface.shared.moduleInfo(
