...
class SKCodeCompletionSessionTests: SylvesterTestCase {
    ...
    func testCodeCompletionOptionsSourceKitObjectConvertible() {
        ...
        let defaultSourceKitdObject = codeCompletionOptions.sourceKitObject
        XCTAssertNotNil(defaultSourceKitdObject,
                        "`sourcekitdObject` returns nil for default options.")

        SylvesterAssertEqual(defaultSourceKitdObject!.description,
                             expected: """
                                       {
    ...
    func testOpenTwoDifferentSessions() {
        ...
        let secondRequest = createMockRequest(filterText: filterTextStrings.first!, offset: 730)
    ...
    func createMockRequest(filterText: String? = nil, offset: Offset = 521) -> SKCodeCompletionSession {
        let session = SKCodeCompletionSession(filePath: filePath(for: .viewController),
                                              offset: offset,
